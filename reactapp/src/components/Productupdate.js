...
var d=parseInt(s.replace(/\D/g, ""));
  ...
  React.useEffect(() => {
    fetch("https://8080-eedcfcabedcfddaaebecafccddbebaee.examlyiopb.examly.io/product/"+d).then((response)=>{
...
setState({
  ...
  const handleUpdate=()=>{
    fetch("https://8080-eedcfcabedcfddaaebecafccddbebaee.examlyiopb.examly.io/product/"+d, {
        method: "PUT",
        headers: {
